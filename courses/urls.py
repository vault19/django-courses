...
urlpatterns = [
    ...
    path('course/<str:run_slug>/<str:chapter_slug>/<str:lecture_type>/', views.chapter_lecture_types,
         name='chapter_lecture_types'),

    # path('course/<str:run_slug>/<str:curriculum_slug>/<int:lecture_id>/', views.lecture_detail,
    #      name='lecture_detail'),
