# Generated by Django 3.2.5 on 2021-08-02 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end', models.DateField(blank=True, help_text='Date will be calculated automatically if any of the curriculums has length set.', null=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.course')),
            ],
        ),
        migrations.CreateModel(
