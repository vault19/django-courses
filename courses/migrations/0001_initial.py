    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(help_text='Full description of the chapter. Explain what will user learn in this lesson.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.FileField(blank=True, help_text='Upload study material (document, video, image).', null=True, upload_to='lectures', validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'gif', 'png', 'tiff', 'svg', 'pdf', 'mkv', 'avi', 'mp4', 'mov'])])),
                ('data_metadata', models.JSONField(blank=True, help_text='Metadata about uploaded data to use in template generator.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.FileField(blank=True, help_text='Upload proof of your work (document, video, image).', null=True, upload_to='submissions', validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'png', 'pdf'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data', models.FileField(upload_to='certificates', validators=[django.core.validators.FileExtensionValidator(['pdf'])])),
                ('run', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.run')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
